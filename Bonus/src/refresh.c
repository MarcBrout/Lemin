...
** Last update Sun Apr 24 16:48:36 2016 benjamin duhieu
*/
...
void	anim_ant(int id_room_start, int id_room_end, t_info *info)
{
  ...
  find_max(info);
  c_x = (info->elem[id_room_end].pos.x - info->elem[id_room_start].pos.x) *
      info->spacer.x / info->speed;
  c_y = (info->elem[id_room_end].pos.y - info->elem[id_room_start].pos.y) *
